...
namespace MenuTest
{
    ...
    {
        /// <summary>
        /// Sets the soda flavor to cherry
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Sets the soda flavor to orange
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Sets the soda flavor to vanilla
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Sets the soda flavor to chocolate
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Sets the soda flavor to rootbeer
        /// </summary>
        [Fact]
        ...
        [InlineData(Size.Medium)]
        [InlineData(Size.Large)]
        public void ChangingSizesShouldNotifyOfCaloriesPropertyChange(Size size)
        {
            Sodasaurus soda = new Sodasaurus();
        ...
        public void ChangingFlavorShouldNotifyOfDescriptionPropertyChange(SodasaurusFlavor flavor)
        {
            Sodasaurus soda = new Sodasaurus();
